...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full p-10 bg-transparent transition-all duration-300 ease-in-out z-10 text-white hover:bg-black hover:bg-opacity-50">
