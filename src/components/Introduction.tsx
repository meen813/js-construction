        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <p className="text-2xl md:text-3xl font-bold text-gray-900">
              Licensed General Contractor in Orange & LA County.
            </p>
            <p className="text-lg md:text-xl text-gray-700 font-medium">
              We deliver ADA compliance, commercial renovation, and site improvement with precision.
            </p>
            <p className="text-xl md:text-2xl font-extrabold text-gray-900 tracking-wide">
              Quality. Compliance. Safety. Every project.
            </p>
          </div>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-emerald-500 mx-auto mt-8 rounded-full"></div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {commercialServices.map((service, index) => (
              <div key={index} className="card p-4 md:p-6 lg:p-8 group">
                {/* Icon */}
